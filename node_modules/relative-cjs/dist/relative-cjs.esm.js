...
function unixify$1(str) {
  return str.replace(/[\\\/]+/g, '/');
}

var index = (function (from, to) {
  var relativePath = relative_1(from, to);
  var unixifiedPath = unixify$1(relativePath);
  if (unixifiedPath.length === 1 && unixifiedPath === '.') return './.';else if (unixifiedPath.charAt(0) === '.') return unixifiedPath;else return './' + unixifiedPath;
});
